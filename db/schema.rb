...
ActiveRecord::Schema.define(version: 20150315062255) do
  ...
  create_table "spree_variant_properties", force: true do |t|
    t.integer  "variant_id"
    t.integer  "property_id"
    t.text     "value"
    t.datetime "created_at"
  ...
  add_index "spree_variant_properties", ["property_id"], name: "index_spree_variant_properties_on_property_id"
  add_index "spree_variant_properties", ["variant_id"], name: "index_spree_variant_properties_on_variant_id"
